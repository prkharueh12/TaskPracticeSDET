...
public class LoginTest_04BothEmpty {
WebDriver driver;
	...
	public void testSlides () {
		...
		driver.findElement(By.xpath("//input[@id=\"username\"]")).sendKeys(emptyUserName);
		...
		if(verify.getText().contains("Error:")) {
			System.out.println("PASS (Expected to see: Error: Username is required.)");
		}else {
